cca
d=load('data/percent_deaths_remaining_expected.mat');
...
%%
hold on
plot([datetime('today') datetime('today')],[0 14]/4,'k--')
plot([datetime('today') datetime('today')],[25 100]/4,'k--')
hold off
...
txt=text(datetime(2021,1,1),4.9,sprintf('X''s are CDC data\n%.2f%% as of Jan 8th',6.69/330*100),'fontsize',20)
...
plot([start_date d.days(ind50)],[50 50]/4,'k--','linewidth',4)
% 
...
plot([start_date d.days(ind70)],[30 30]/4,'k--','linewidth',4)
hold off
